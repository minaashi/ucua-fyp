...
function resolveReport(reportId) {
    ...
    $('#reportId').val(reportId);
    // In a real application, you might fetch report details for the modal
    // or just use the reportId to submit the resolution form.
}
...
function addRemarks(reportId) {
    ...
    $('#reportId').val(reportId);
     // In a real application, you might fetch existing remarks or report details
    // for the modal.
}
</script>
@endpush 