            ...
            <ul class="space-y-2">
                ...
                <li>
                    <a href="{{ route('department.notifications') }}"
                       class="flex items-center px-4 py-2 {{ Request::routeIs('department.notifications') ? 'bg-red-50 text-red-600' : 'text-gray-600' }} hover:bg-red-100 hover:text-red-700 transition-colors duration-200">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-3">
                        ...
                        @endif
                        <a href="{{ route('department.dashboard') }}" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors">
